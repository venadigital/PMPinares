    ...
    <section className="space-y-4">
      <div className="grid gap-3 md:grid-cols-2">
        <TabButton
          ...
          description="Captura una observacion, define criticidad, area responsable y adjunta evidencias si aplica."
        ...
        <TabButton
          ...
          description="Consulta, edita y soporta las observaciones consolidadas del diagnostico."
          meta={`${findingCount} hallazgos`}
          secondaryMeta={criticalCount > 0 ? `${criticalCount} criticos` : undefined}
