-- Pinares Project Control - reset seguro para proyecto Supabase nuevo.
-- Borra solo objetos creados por esta app y vuelve a crear schema, storage, policies y seeds.

drop table if exists public.entity_links cascade;
drop table if exists public.decisions cascade;
drop table if exists public.risk_attachments cascade;
drop table if exists public.risks cascade;
drop table if exists public.finding_attachments cascade;
drop table if exists public.findings cascade;
drop table if exists public.processes cascade;
drop table if exists public.interviews cascade;
drop table if exists public.technology_tool_attachments cascade;
drop table if exists public.technology_tools cascade;
drop table if exists public.wall_post_tags cascade;
drop table if exists public.wall_attachments cascade;
drop table if exists public.tags cascade;
drop table if exists public.wall_comments cascade;
drop table if exists public.wall_posts cascade;
drop table if exists public.task_deliverables cascade;
...
drop function if exists public.has_module_access(text) cascade;
...
drop type if exists traffic_light cascade;
